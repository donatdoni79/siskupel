  ...
  <div class="card">
    <div class="card-body login-card-body" style="border-radius: 10px;">
      ...
      <div class="login-logo">
        <div class="row">
          <div class="col-md-3">
            <img src="<?= base_url('assets/img/isn.png') ?>" class="img img-fluid" style="height:45px;">
          </div>
          <div class="col-md-9 text-left">
            <!-- <h1><?=$site['namaweb'] ?></h1> -->
            <h3>PT INFOMEDIA SOLUSI NET</h3>
            <!-- <p style="font-size: 12px; font-weight: bold;"><?=$site['tagline'] ?></p> -->
            <p style="font-size: 16px; font-weight: bold;">Sistem Informasi Kunjungan Pelanggan (SISKUPEL)</p>
          </div>
        </div>
      </div>
      <hr>
...
<?= form_open(base_url('login')); ?>
      ...
      <p class="mb-1 text-center">
        <a href="#">Lupa Password?</a> | <a href="#" class="text-center">Home</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
